...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center bg-gray-50 p-6 gap-6">
      {/* Hero Section */}
      <section className="relative h-96 flex items-center justify-center bg-black mt-10">
